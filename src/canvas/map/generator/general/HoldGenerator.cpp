...
void HoldGenerator::generate_preview(Hold &hold) {
  ...
  // 直接添加图形到队列
  preview_shape_queue.emplace(hold_vert_body_rect.x(), hold_vert_body_rect.y(),
                              hold_vert_body_rect.width(),
                              hold_vert_body_rect.height(),
                              hold_vert_body_texture, objref);
  ...
  switch (hold.compinfo) {
    case ComplexInfo::NONE: {
      ...
      // 直接添加面尾图形到队列
      preview_shape_queue.emplace(hold_end_rect.x(), hold_end_rect.y(),
                                  hold_end_rect.width(), hold_end_rect.height(),
                                  hold_end_texture, objref);
