...
void AbstractRenderer::render(const ShapeType& shape,
    ...
    switch (shape) {
        ...
        case ShapeType::OVAL: {
            DRAWCALL(cvs->glDrawArraysInstancedBaseInstance(
                GL_TRIANGLE_FAN, 4, oval_segment, shape_count,
                start_shape_index));
            break;
        }
    }
