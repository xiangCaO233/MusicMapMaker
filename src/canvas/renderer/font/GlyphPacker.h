...
class GlyphPacker {
 public:
  ...
  GlyphPacker(int maxWidth, int maxHeight);
  ...
  int Insert(CharacterGlyph *glyph, FreeRectChoiceHeuristic method);

  // 移除字形
  int Erase(CharacterGlyph *glyph);
  ...
  std::vector<std::shared_ptr<CharacterGlyph *>> restex;
 ...
 private:
  ...
  int CommonIntervalLength(int i1start, int i1end, int i2start,
                           int i2end) const;
