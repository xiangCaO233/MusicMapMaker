...
void Renderer2D::initMeshObjectBuffers() {
  ...
  GLCALL(cvs->glBufferData(GL_ARRAY_BUFFER,
                           max_mesh_vertexcount * sizeof(CustomVertex), nullptr,
                           GL_DYNAMIC_DRAW),
         cvs);
  ...
  GLCALL(cvs->glVertexAttribPointer(0, 2, GL_FLOAT, false, sizeof(CustomVertex),
  ...
  GLCALL(cvs->glVertexAttribPointer(1, 2, GL_FLOAT, false, sizeof(CustomVertex),
  ...
  GLCALL(cvs->glVertexAttribPointer(2, 4, GL_FLOAT, false, sizeof(CustomVertex),
  ...
  GLCALL(cvs->glVertexAttribPointer(3, 2, GL_FLOAT, false, sizeof(CustomVertex),
