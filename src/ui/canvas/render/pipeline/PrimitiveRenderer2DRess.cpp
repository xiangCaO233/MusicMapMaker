...
void Renderer2D::initPrimitiveObjectBuffers() {
  ...
  GLCALL(cvs->glBufferData(GL_ARRAY_BUFFER,
                           max_primitivecount * sizeof(PrimitiveData), nullptr,
                           GL_DYNAMIC_DRAW),
         cvs);
  ...
  GLCALL(
      cvs->glVertexAttribPointer(8, 2, GL_FLOAT, false, sizeof(PrimitiveData),
  ...
  GLCALL(
      cvs->glVertexAttribIPointer(9, 1, GL_INT, sizeof(PrimitiveData),
  ...
  GLCALL(
      cvs->glVertexAttribIPointer(10, 1, GL_UNSIGNED_INT, sizeof(PrimitiveData),
  ...
  GLCALL(
      cvs->glVertexAttribIPointer(11, 1, GL_UNSIGNED_INT, sizeof(PrimitiveData),
  ...
  GLCALL(
      cvs->glVertexAttribIPointer(12, 1, GL_UNSIGNED_INT, sizeof(PrimitiveData),
  ...
  GLCALL(
      cvs->glVertexAttribIPointer(13, 1, GL_UNSIGNED_INT, sizeof(PrimitiveData),
